...
const RobotA = 0
const RobotB = 1
const TOT = 3 //numero totale di auto da montare
...
/*
	NB: questi invece, sono sincroni
*/
...
func deposito() {
	...
	for {
		...
		// NB: la presenza del flag di fine nella condizione di sincronizzazione

		// NB_2: le condizioni numCA < maxC-1 evitano di saturare il deposito con solo prodotti di un tipo solo.
		// 		 In questo modo non si blocca mai il robot produttore e non si causano situazioni di deadlock
		//		 dovute alla priorità di prelievo/inserimento.
